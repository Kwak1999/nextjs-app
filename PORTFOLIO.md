...
## 기능 정의서 (초안)
> 실제 기획 산출물로 대체 가능. 용어는 개발 관점으로 정리.
...
## API 설계서 (초안)
> 실제 API 문서로 대체 가능. Route Handler 기준 예시.
...
## 레퍼런스
- **기능 정의서(완성본)**: [링크 입력](https://example.com)
- **페이지 기획서**: [링크 입력](https://example.com)
- **DB & API 설계서(완성본)**: [링크 입력](https://example.com)
- **데모 영상(산출물)**: [링크 입력](https://example.com)
